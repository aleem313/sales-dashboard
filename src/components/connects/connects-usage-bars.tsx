  ...
  return (
    <div className="rounded-[10px] border border-border bg-card">
      <div className="flex items-center justify-between border-b border-border px-[18px] py-3.5">
        ...
        <span className="rounded-md bg-accent-warn/10 px-2 py-0.5 text-[12px] font-medium uppercase tracking-[0.1em] text-accent-warn">
          Budget Watch
        </span>
      </div>
      <div className="p-[18px]">
        <div className="flex flex-wrap gap-3">
          ...
          {data.length === 0 && (
            <div className="w-full py-6 text-center text-[13.5px] text-muted-foreground">
